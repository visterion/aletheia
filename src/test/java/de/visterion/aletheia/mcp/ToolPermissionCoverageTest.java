 ...
 * duplicated tool registration (guarded by the exact count of 23).
 */
class ToolPermissionCoverageTest {
  ...
  @Test
  void everyDeclaredToolIsCoveredByThePermissionServiceAndThereAreExactlyTwentyThree() {
    ...
    assertThat(allToolNames).as("exactly 23 MCP tools are registered").hasSize(23);
