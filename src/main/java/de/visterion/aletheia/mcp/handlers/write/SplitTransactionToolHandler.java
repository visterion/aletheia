...
public class SplitTransactionToolHandler implements ToolHandler {
  ...
  public String description() {
    return "Answers: how do I break one raw booking into several logical parts, e.g. a mixed"
        + " purchase or cash spent on several things? Split an existing raw transaction into"
        + " logical child positions (replace semantics)."
