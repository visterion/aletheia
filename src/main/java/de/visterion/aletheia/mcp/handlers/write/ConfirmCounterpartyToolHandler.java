...
public class ConfirmCounterpartyToolHandler implements ToolHandler {
  ...
  public String description() {
    return "Answers: how do I confirm that a counterparty or contract really is an obligation (a"
        + " recurring series is materialized where one exists)? The human's 'yes'. SINGLE:"
        + " counterpartyId (+ optional contractId to confirm just that"
        ...
        + " SINGLE-item mode also accepts an optional cadence"
