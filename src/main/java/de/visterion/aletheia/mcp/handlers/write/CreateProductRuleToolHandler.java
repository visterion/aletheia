...
public class CreateProductRuleToolHandler implements ToolHandler {
  ...
  public String description() {
    return "Answers: one SEPA mandate pays for several products at once -- how do I get one"
        ...
        + " dryRun=true writes nothing and returns the blast radius (bookings matched, positions"
        + " parsed, sum mismatches) -- always dry-run first and check the numbers. dryRun=false"
